...
| [`evidence-first-delivery`](/docs/user-guide/skills/bundled/productivity/productivity-evidence-first-delivery) | Deliver multi-step work with verified outcomes. | `productivity\evidence-first-delivery` |
